...
class ConfsepContent(models.Model):
    ...
    checked_out_time = models.DateTimeField(max_length=255, default=datetime.min, blank=True)
    publish_up = models.DateTimeField(default=timezone.now)
    publish_down = models.DateTimeField(max_length=255, default=datetime.min, blank=True)
    images = models.TextField()
